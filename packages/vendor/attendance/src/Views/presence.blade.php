        ...
        <div class="page-heading">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">Historique des présences</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <!-- Ajoutez ces deux barres de progression après l'alerte loading-alert (vers ligne 135) -->
    ...
    <p class="mb-0 small mt-2 text-muted" id="pdf-progress-details">
        ...
        Préparation du document PDF...
                        ...
                        <div class="table-responsive">
                            <table id="presences-table" class="table table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Code</th>
...
$(document).ready(function() {
    ...
    function simulatePdfProgress(callback) {
        ...
        var steps = [
            ...
            { progress: 30, message: 'Récupération des présences...' },
    ...
    var table = $('#presences-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('admin.daily-attendance.presence.data') }}",
            type: 'GET',
            data: function(d) {
            ...
            beforeSend: function() {
                ...
                if (!$('#data-progress-container').hasClass('d-none')) {
                    ...
                    showLoading('Chargement des présences...');
                }
            },
            complete: function() {
                hideLoading();
        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    else if (status === 'LATE') badgeClass = 'warning';
                    else if (status === 'EARLY_LEAVE') badgeClass = 'warning';
                    else if (status === 'HALF_DAY') badgeClass = 'info';
                    else if (status === 'OVERTIME') badgeClass = 'primary';
        ...
        drawCallback: function(settings) {
            ...
            console.log('Affichage ' + pageInfo.recordsDisplay + ' enregistrements');
        }
    });
    ...
    $('#apply_filters').on('click', function() {
        ...
        showDataProgress('Chargement des présences...', details);
        
        // Simulation des étapes de progression
        var steps = [
            { progress: 10, message: 'Initialisation de la requête...' },
            { progress: 25, message: 'Récupération des présences...' },
    ...
    $('#exportPdfBtn').click(function() {
        ...
        $.ajax({
            url: "{{ route('admin.daily-attendance.presences.export-pdf') }}",
            type: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
