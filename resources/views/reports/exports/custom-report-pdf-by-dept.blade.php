...
<body>
    ...
    @php
        $weekStart = \Carbon\Carbon::parse($start_date);
        $weekEnd   = \Carbon\Carbon::parse($end_date);
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @foreach($days_list as $day)
                        ...
                        {{-- ── MISSION : une seule cellule fusionnée (colspan=2) ── --}}
                        @if($status === 'MISSION')
                            <td colspan="2" class="mission-cell">
                                Mission
                            </td>

                        {{-- ── CONGÉ : une seule cellule fusionnée (colspan=2) ── --}}
                        @elseif($status === 'CONGE')
