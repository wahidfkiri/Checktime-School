            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Supervision — Départements</h3>
                        <p class="text-subtitle text-muted">Tous les départements, toutes écoles confondues</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <h4 class="card-title mb-0">Départements</h4>
...
$(document).ready(function() {
    var table = $('#sup-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('super-admin.supervision.departments.data') }}",
